...
export default function ViewerProfile(props) {
    ...
    const {data, setData, put, reset, errors} = useForm({ name: auth.user.name, email: auth.user.email, username: auth.user.username, address: auth.user.address, avatar:auth.user.id });
                ...
                <div className="card shadow-lg mx-4 my-3">
                    ...
                    <div className="row gx-4">
                        ...
                        <div className="avatar avatar-xl position-relative">
                            <img src={'/avatar/avatars/' + auth.user.avatar +'.jpg'} alt="profile_image" className="w-100 border-radius-lg shadow-sm" />
                        </div>
                        </div>
                        ...
                        <form action={ route('profile.upload') } method="POST" enctype="multipart/form-data">
                            ...
                            <div className="col-md-6 ">
                                        <div className='form-group'>
                                            <label htmlFor="avatar" className="form-control-label">Change avatar</label>
                                                {selectedImage && (
                                                    <div>
                        ...
                        <div className="card card-profile pb-7">
                            ...
                            <div className="row justify-content-center">
                                ...
                                <div className="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                                    <a href="javascript:;">
                                    <img src={'/img/user_avt/' + auth.user.avatar} className="rounded-circle img-fluid border border-2 border-white" />
                                    </a>
                                </div>
                                </div>
                            </div>
